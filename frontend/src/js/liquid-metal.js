(function () {
  ...
  function Node(x, y, radius, stretch, angle) {
    this.x = x; this.y = y;
    this.radius = radius;
    this.baseRadius = radius;
    this.stretch = stretch || 1 + Math.random() * 5;
  ...
  function animate() {
    ...
    for (var i = 0; i < ambientNodes.length; i++) {
      ...
      if (dist < influence && dist > 0) {
        ...
        n.stretch += (n.baseStretch - n.stretch) * 0.08;
      }
    }

    var allNodes = ambientNodes.concat([cursor]);
